...
declare namespace $ {
	...
	>
	type $mol_list__rows_mol_book2_catalog_6 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['menu_links'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_page__title_mol_book2_catalog_7 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['menu_title'] >
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__Logo_mol_book2_catalog_8 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['Menu_logo'] >
		,
		ReturnType< $mol_page['Logo'] >
	>
	type $mol_page__tools_mol_book2_catalog_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__head_mol_book2_catalog_10 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['menu_head'] >
		,
		ReturnType< $mol_page['head'] >
	>
	type $mol_page__body_mol_book2_catalog_11 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['menu_body'] >
		,
		ReturnType< $mol_page['body'] >
	>
	type $mol_page__foot_mol_book2_catalog_12 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['menu_foot'] >
		,
		ReturnType< $mol_page['foot'] >
	>
	type $mol_link__arg_mol_book2_catalog_13 = $mol_type_enforce<
		ReturnType< $mol_book2_catalog['spread_close_arg'] >
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__hint_mol_book2_catalog_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['hint'] >
	>
	type $mol_link__sub_mol_book2_catalog_15 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
...
declare namespace $ {
    ...
    function $hyoo_crus_vary_cast_json(vary: $hyoo_crus_vary_type): object | null;
    ...
    function $hyoo_crus_vary_cast<Tip extends keyof typeof $hyoo_crus_vary_tip>(tip: Tip, vary: $hyoo_crus_vary_type): string | number | bigint | boolean | object | null;
}
...
declare namespace $ {
    ...
    const $hyoo_crus_list_json_base: (abstract new () => {
        items(next?: readonly (object | null)[] | undefined): readonly (object | null)[];
        items_vary(next?: readonly $hyoo_crus_vary_type[], tag?: keyof typeof $hyoo_crus_sand_tag): readonly $hyoo_crus_vary_type[];
        splice(next: readonly $hyoo_crus_vary_type[], from?: number, to?: number, tag?: keyof typeof $hyoo_crus_sand_tag): void;
        find(vary: $hyoo_crus_vary_type): $hyoo_crus_sand | null;
        has(vary: $hyoo_crus_vary_type, next?: boolean, tag?: keyof typeof $hyoo_crus_sand_tag): boolean;
...
declare namespace $ {
    ...
    const $hyoo_crus_atom_json_base: (abstract new () => {
        val(next?: object | null | undefined): object | null;
        val_of(peer: string | null, next?: object | null | undefined): object | null;
        pick_unit(peer: string | null): $hyoo_crus_sand | undefined;
        vary(next?: $hyoo_crus_vary_type): $hyoo_crus_vary_type;
        vary_of(peer: string | null, next?: $hyoo_crus_vary_type): $hyoo_crus_vary_type;
        land(): $hyoo_crus_land;
...
declare namespace $ {
    const $hyoo_budget_category_base: Omit<typeof $hyoo_crus_entity, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_entity, {
        readonly Limit: (auto?: any) => $hyoo_crus_atom_real | null;
        readonly Transfer: (auto?: any) => {
            ...
            make(config?: null | $hyoo_crus_rank_preset | $hyoo_crus_land): $hyoo_budget_transfer;
        ...
        schema: {
            ...
            readonly Limit: typeof $hyoo_crus_atom_real;
            readonly Transfer: {
                new (): {
                    remote_list(next?: readonly $hyoo_budget_transfer[] | undefined): readonly $hyoo_budget_transfer[];
                    remote_add(item: $hyoo_budget_transfer): void;
                ...
                Value: () => typeof $hyoo_budget_transfer;
                toString(): any;
                parse: typeof $hyoo_crus_vary_cast_ref;
                tag: keyof typeof $hyoo_crus_sand_tag;
                make<This extends typeof $mol_object>(this: This, config: Partial<InstanceType<This>>): InstanceType<This>;
    ...
    export class $hyoo_budget_category extends $hyoo_budget_category_base {
        limit(next?: number): number | null;
        transfer_list(): readonly $hyoo_budget_transfer[];
        transfer_make(): $hyoo_budget_transfer;
        transfer_visible(transfer: $hyoo_budget_transfer, next?: boolean): boolean;
        ballance(): number;
    }
    export {};
}
...
declare namespace $ {
    const $hyoo_budget_fund_base: Omit<typeof $hyoo_crus_entity, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_entity, {
        readonly Limit: (auto?: any) => $hyoo_crus_atom_real | null;
        readonly Category: (auto?: any) => {
            ...
            make(config?: null | $hyoo_crus_rank_preset | $hyoo_crus_land): $hyoo_budget_category;
        ...
        schema: {
            ...
            readonly Category: {
                ...
                Value: () => typeof $hyoo_budget_category;
                toString(): any;
                parse: typeof $hyoo_crus_vary_cast_ref;
                tag: keyof typeof $hyoo_crus_sand_tag;
                make<This extends typeof $mol_object>(this: This, config: Partial<InstanceType<This>>): InstanceType<This>;
    ...
    export class $hyoo_budget_fund extends $hyoo_budget_fund_base {
        limit(next?: number): number | null;
        category_list(): readonly $hyoo_budget_category[];
...
declare namespace $ {
	...
	type _hyoo_budget_transfer_row_1 = $mol_type_enforce<
		...
		,
		Parameters< ReturnType< $hyoo_budget_transfer_row['transfer'] >['amount'] >[0]
	>
	type _hyoo_budget_transfer_row_2 = $mol_type_enforce<
		Parameters< $hyoo_budget_transfer_row['description'] >[0]
		,
...
declare namespace $ {
	...
	type $mol_button_minor__hint_hyoo_budget_category_page_1 = $mol_type_enforce<
		...
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_hyoo_budget_category_page_2 = $mol_type_enforce<
		ReturnType< $hyoo_budget_category_page['transfer_make'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	...
	export class $hyoo_budget_category_page extends $mol_page {
		...
		Delete( id: any): $mol_button_minor
		Transfer_row( id: any): $hyoo_budget_transfer_row
...
//# sourceMappingURL=page.view.tree.d.ts.map
declare namespace $.$$ {
    class $hyoo_budget_category_page extends $.$hyoo_budget_category_page {
        title(): string;
        category_title(next?: string): string;
        limit(next?: number): number | null;
        transfer_list(): $hyoo_budget_transfer_row[];
        transfer(id: string): $hyoo_budget_transfer;
...
declare namespace $.$$ {
    class $hyoo_budget_fund_book extends $.$hyoo_budget_fund_book {
        menu_title(): string;
        fund_title(next?: string): string;
        limit(next?: number): number | null;
        spread_ids(): string[];
