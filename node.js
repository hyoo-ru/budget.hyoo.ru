...
var $;
(function ($) {
    class $hyoo_budget_transfer extends $hyoo_crus_dict.with({
...
var $;
(function ($) {
    class $hyoo_budget_category extends $hyoo_crus_entity.with({
        ...
        transfer_visible(transfer, next) {
    ...
    __decorate([
        $mol_mem
    ], $hyoo_budget_category.prototype, "transfer_list", null);
    __decorate([
        $mol_action
    ], $hyoo_budget_category.prototype, "transfer_make", null);
    __decorate([
        $mol_mem
    ], $hyoo_budget_category.prototype, "ballance", null);
    $.$hyoo_budget_category = $hyoo_budget_category;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $hyoo_budget_fund extends $hyoo_crus_entity.with({
        Limit: $hyoo_crus_atom_real,
        ...
        category_visible(category, next) {
    ...
    __decorate([
        $mol_mem
    ], $hyoo_budget_fund.prototype, "category_list", null);
    __decorate([
        $mol_mem
...
;
	($.$hyoo_budget_transfer_row) = class $hyoo_budget_transfer_row extends ($.$mol_view) {
		amount(next){
			return (this.transfer().amount(next));
		}
		description(next){
			return (this.transfer().description(next));
		}
		moment(next){
		...
		transfer(){
			const obj = new this.$.$hyoo_budget_transfer();
			return obj;
		}
		sub(){
			return [
	...
	($mol_mem(($.$hyoo_budget_transfer_row.prototype), "Amount"));
	($mol_mem(($.$hyoo_budget_transfer_row.prototype), "Description"));
	($mol_mem(($.$hyoo_budget_transfer_row.prototype), "Moment"));
	($mol_mem(($.$hyoo_budget_transfer_row.prototype), "transfer"));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($hyoo_budget_transfer_row, {
            Amount: {
                flex: {
                    basis: `5rem`,
                },
...
;
	($.$hyoo_budget_category_page) = class $hyoo_budget_category_page extends ($.$mol_page) {
		...
		Transfer_row(id){
			const obj = new this.$.$hyoo_budget_transfer_row();
			(obj.transfer) = () => ((this.transfer(id)));
			(obj.addon) = () => ([(this.Delete(id))]);
			return obj;
		}
		transfer_list(){
			return [(this.Transfer_row("0"))];
		}
		Transfer_list_empty(){
			const obj = new this.$.$mol_status();
			(obj.title) = () => ((this.$.$mol_locale.text("$hyoo_budget_category_page_Transfer_list_empty_title")));
			return obj;
		}
		Transfer_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.transfer_list()));
	...
	($mol_mem(($.$hyoo_budget_category_page.prototype), "transfer_make"));
	($mol_mem(($.$hyoo_budget_category_page.prototype), "Transfer_make_icon"));
	($mol_mem(($.$hyoo_budget_category_page.prototype), "Transfer_make"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_budget_category_page.prototype, "transfer_list", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_budget_category_page.prototype, "transfer", null);
        $$.$hyoo_budget_category_page = $hyoo_budget_category_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$hyoo_budget_fund_book) = class $hyoo_budget_fund_book extends ($.$mol_book2_catalog) {
		...
		Visible(){
			const obj = new this.$.$mol_check_icon();
			(obj.hint) = () => ((this.$.$mol_locale.text("$hyoo_budget_fund_book_Visible_hint")));
			(obj.checked) = (next) => ((this.visible(next)));
			(obj.sub) = () => ([(this.Visible_icon())]);
			return obj;
		}
		...
		Category_page(id){
			const obj = new this.$.$hyoo_budget_category_page();
			(obj.category) = () => ((this.category(id)));
			(obj.addon) = () => ([(this.Spread_close())]);
			(obj.visible) = (next) => ((this.category_visible(id, next)));
			return obj;
		}
		param(){
			return "category";
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_budget_fund_book.prototype, "spread_ids", null);
        __decorate([
            $mol_mem_key
        ], $hyoo_budget_fund_book.prototype, "category", null);
        __decorate([
            $mol_mem_key
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($hyoo_budget_intro, {
            flex: {
                basis: `50rem`,
            },
        });
...
;
	($.$hyoo_budget_app) = class $hyoo_budget_app extends ($.$mol_book2_catalog) {
		...
		fund_visible(id, next){
			if(next !== undefined) return next;
			return true;
		}
		Fund_page(id){
			const obj = new this.$.$hyoo_budget_fund_book();
			(obj.fund) = () => ((this.fund(id)));
			(obj.menu_addon) = () => ([(this.Spread_close())]);
			(obj.visible) = (next) => ((this.fund_visible(id, next)));
			return obj;
		}
		Theme(){
		...
		Menu_links_empty(){
			const obj = new this.$.$mol_status();
			(obj.title) = () => ((this.$.$mol_locale.text("$hyoo_budget_app_Menu_links_empty_title")));
			return obj;
		}
		menu_foot(){
			return [
		...
		Spread_default(){
			const obj = new this.$.$hyoo_budget_intro();
			return obj;
		}
		plugins(){
			return [(this.Theme())];
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem_key
        ], $hyoo_budget_app.prototype, "fund", null);
        __decorate([
            $mol_mem_key
